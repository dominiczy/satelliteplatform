...
#define fuel_rate_contr_exit_from_Multi (24L)
#define fuel_rate_contro_entry_to_Multi (23L)
#define fuel_rate_control_CALL_EVENT   (-1L)
...
#define fuel_rate_control_event_DEC    (0L)
#define fuel_rate_control_event_INC    (1L)
  ...
  stride)
{
  ...
  u0 = nondet_real32_T();
  u1 = nondet_real32_T();
  stride = nondet_uint32_T();
  
  bp0 = (real32_T const *)malloc(sizeof(real32_T));
  bp1 = (real32_T const *)malloc(sizeof(real32_T));
  table = (real32_T const *)malloc(sizeof(real32_T));
  maxIndex = (uint32_T const *)malloc(sizeof(uint32_T));
   ...
   */
  offset_1d = bpIdx * stride + bpIndices[0UL];
  if (bpIndices[0UL] == maxIndex[0UL]) {
    yL_1d = table[offset_1d];
  } else {
    yL_1d = (table[offset_1d + 1UL] - table[offset_1d]) * fractions[0UL] +
      table[offset_1d];
  }

  if (bpIdx == maxIndex[1UL]) {
    y = yL_1d;
  } else {
    ...
    if (bpIndices[0UL] == maxIndex[0UL]) {
      ...
      yR_1d = (table[bpIdx + 1UL] - table[bpIdx]) * fractions[0UL] + table[bpIdx];
    }
  ...
  switch (fuel_rate_control_DW.bitsForTID0.is_Fueling_Mode) {
          ...
          switch (fuel_rate_control_DW.bitsForTID0.was_Running) {
           case fuel_rate_cont_IN_Low_Emissions:
            if (fuel_rate_control_DW.bitsForTID0.is_Running !=
              ...
              fuel_rate_control_B.fuel_mode = (int16_T)LOW;
            }
           ...
           case fuel_rate_contr_IN_Rich_Mixture:
            if (fuel_rate_control_DW.bitsForTID0.is_Running !=
              ...
              fuel_rate_control_B.fuel_mode = (int16_T)RICH;
            }
   ...
   case fuel_rate_control_IN_Running:
    ...
    if (fuel_rate_control_DW.sfEvent == fuel_rate_contro_entry_to_Multi) {
      ...
      fuel_rate_control_B.fuel_mode = (int16_T)DISABLED;
      fuel_rate_control_DW.bitsForTID0.is_Fuel_Disabled =
        fuel_rate_control_IN_Shutdown;
...
void fuel_rate_control_step(void)
{
    ...
    if (!((fuel_rate_control_DW.bitsForTID0.is_active_O2 == 0U) ||
      ...
      switch (fuel_rate_control_DW.bitsForTID0.is_A) {
       ...
       case fuel_rate_control_IN_O2_warmup:
        ...
        if (fuel_rate_control_DW.temporalCounter_i1 >= 480U) {
          /* Transition: '<S3>:36' */
          fuel_rate_control_DW.bitsForTID0.is_A = fuel_rate_control_IN_O2_normal;
          fuel_rate_control_B.O2_normal = true;
        }
      ...
      switch (fuel_rate_control_DW.bitsForTID0.is_Pressure) {
       case fuel_rate_control_IN_fail:
        ...
        if ((fuel_rate_control_U.sensors.map > 0.05F) &&
          ...
          fuel_rate_control_B.PressureEstimation = look2_iflf_linlca
            (fuel_rate_control_U.sensors.speed,
             ...
             fuel_rate_control_ConstP.PressureEstimation_ma, 18UL);

          /* End of Outputs for SubSystem: '<S3>/Pressure.map_estimate' */
          fuel_rate_control_B.es_o.map = fuel_rate_control_B.PressureEstimation;
        }
        break;
      ...
      switch (fuel_rate_control_DW.bitsForTID0.is_Throttle) {
       case fuel_rate_control_IN_fail:
        ...
        if ((fuel_rate_control_U.sensors.throttle > 3.0F) &&
          ...
          fuel_rate_control_B.ThrottleEstimation = look2_iflf_linlca
      ...
      switch (fuel_rate_control_DW.bitsForTID0.is_Speed) {
       case fuel_rate_control_IN_fail:
        ...
        if (fuel_rate_control_U.sensors.speed > 0.0F) {
          ...
          rtb_SpeedEstimation = look2_iflf_linlca
            (fuel_rate_control_U.sensors.throttle,
             ...
             fuel_rate_control_ConstP.SpeedEstimation_maxIn, 17UL);

          /* Saturate: '<S8>/Saturation' */
          if (rtb_SpeedEstimation > 628.0F) {
            fuel_rate_control_B.es_o.speed = 628.0F;
          } else if (rtb_SpeedEstimation < 0.0F) {
            fuel_rate_control_B.es_o.speed = 0.0F;
          } else {
            fuel_rate_control_B.es_o.speed = rtb_SpeedEstimation;
          }
  ...
  rtb_SpeedEstimation = look2_iflf_linlca(fuel_rate_control_B.es_o.speed,
  ...
  /* Product: '<S2>/Product' */
  rtb_Product = fuel_rate_control_B.es_o.speed * rtb_SpeedEstimation;

  /* DiscreteFilter: '<S2>/Throttle Transient' */
  denAccum = fuel_rate_control_B.es_o.throttle - -0.8F *
  ...
  if (fuel_rate_control_B.O2_normal && (fuel_rate_control_B.fuel_mode == LOW)) {
    ...
    rtb_SpeedEstimation = look2_iflf_linlca(fuel_rate_control_B.es_o.speed,
      ...
      fuel_rate_control_ConstP.RampRateKi_maxIndex, 6UL);
    rtb_holdintegrator = ((real32_T)(fuel_rate_control_B.es_o.ego <= 0.5F) -
                          0.5F) * rtb_SpeedEstimation;
  } else {
  ...
  switch (fuel_rate_control_B.fuel_mode) {
   case LOW:
    rtb_SpeedEstimation = 0.0684931502F;
    break;

   case RICH:
    rtb_SpeedEstimation = 0.0856164396F;
    break;

   default:
    rtb_SpeedEstimation = 0.0F;
    break;
  }
   ...
   *  Sum: '<S2>/Sum'
   */
  rtb_SpeedEstimation *= (0.01F * denAccum + -0.01F *
  ...
  switch (fuel_rate_control_B.fuel_mode) {
   case LOW:
    ...
    fuel_rate_control_Y.fuel_rate = (8.7696F * rtb_Product + -8.5104F *
      fuel_rate_control_DW.DiscreteFilter_states_i) + rtb_SpeedEstimation;
   ...
   case RICH:
     ...
     *  Sum: '<S14>/Sum2'
     */
    fuel_rate_control_DW.DiscreteFilter_states = (rtb_SpeedEstimation +
